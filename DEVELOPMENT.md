...
```bash
git remote add encore encore://ai-text-transformer-backend-b8ri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-text-transformer-backend-b8ri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-text-transformer-backend-b8ri/settings/integrations/github)
