...
export class Client {
    ...
    public readonly transform: transform.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.transform = new transform.ServiceClient(base)
    }
...
import {
    getProfile as api_auth_user_getProfile,
    getStats as api_auth_user_getStats,
    updateLLMKey as api_auth_user_updateLLMKey
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.updateLLMKey = this.updateLLMKey.bind(this)
        }

        /**
         * Gets the current user's profile.
         */
        public async getProfile(): Promise<ResponseType<typeof api_auth_user_getProfile>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/profile`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_user_getProfile>
        }

        /**
         * Gets user stats and recent transformations.
         */
        public async getStats(): Promise<ResponseType<typeof api_auth_user_getStats>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/stats`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_user_getStats>
        }
         ...
         */
        public async updateLLMKey(params: RequestType<typeof api_auth_user_updateLLMKey>): Promise<void> {
            await this.baseClient.callTypedAPI(`/auth/llm-key`, {method: "PUT", body: JSON.stringify(params)})
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getToken as api_token_token_getToken } from "~backend/token/token";
...
export namespace token {
    ...
    export class ServiceClient {
         ...
         */
        public async getToken(params: RequestType<typeof api_token_token_getToken>): Promise<ResponseType<typeof api_token_token_getToken>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/token`, {method: "POST", body: JSON.stringify(params)})
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { transform as api_transform_transform_transform } from "~backend/transform/transform";
...
export namespace transform {
    ...
    export class ServiceClient {
         ...
         */
        public async transform(params: RequestType<typeof api_transform_transform_transform>): Promise<ResponseType<typeof api_transform_transform_transform>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/transform`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_transform_transform_transform>
        }
    }
}
